        ...
        try:
            ...
            for container_name, container_data in dependencies.items():
                ...
                if 'web' in container_name:
                    ...
                    assert 'project' in container_data, f"Missing 'project' for container {container_name}"
                    assert 'system' in container_data, f"Missing 'system' for container {container_name}"

                    project_packages = container_data.get('project', {}).get('packages', [])
                    system_packages = container_data.get('system', {}).get('packages', [])
                    ...
                    # Pre-built containers may have empty project/system sections
