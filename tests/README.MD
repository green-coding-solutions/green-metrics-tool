...
This can be, and is recommended, to do with parallel testing enabled:
...
If you experience errors with this you can also fallback to sequential testing by just issuing:
