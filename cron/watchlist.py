    ...
    for [item_id, name, repo_url, branch, filename, usage_scenario_variables, machine_id, user_id, schedule_mode, last_marker, scheduled_today, scheduled_last_week] in data:
        ...
        if schedule_mode == 'daily':
            if not scheduled_today:
                ...
                Job.insert('run', user_id=user_id, name=name, url=repo_url, branch=branch, filename=filename, usage_scenario_variables=usage_scenario_variables, machine_id=machine_id)
                print('\tInserted')
