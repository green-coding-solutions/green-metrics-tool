...
from metric_providers.memory.used.cgroup.container.provider import MemoryUsedCgroupContainerProvider
...
class MemoryUsedCgroupSystemProvider(MemoryUsedCgroupContainerProvider):
    ...
    def read_metrics(self, run_id, containers=None):
        return super().read_metrics(run_id, self._cgroups) # this will call MemoryUsedCgroupContainerProvider
