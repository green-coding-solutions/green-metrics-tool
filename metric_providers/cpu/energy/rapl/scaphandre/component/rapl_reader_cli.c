 ...
 *
 * Usage:
 *   metric-provider-binary.exe -i <interval_ms>        (default: 99ms)
 *   metric-provider-binary.exe -i 99 -d cpu_package    (single domain)
 *   metric-provider-binary.exe -c                      (check mode)
 *
