...
class NetworkDockerStatsContainerProvider(BaseMetricProvider):
        def __init__(self, resolution):
            self._current_dir = os.path.dirname(os.path.abspath(__file__))
            self._metric_name = "network_docker_stats_container"
...
if __name__ == "__main__":
    ...
    o = NetworkDockerStatsContainerProvider(resolution=100)
