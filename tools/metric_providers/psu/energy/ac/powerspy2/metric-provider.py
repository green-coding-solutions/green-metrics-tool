...
if __name__ == '__main__':
    ...
    parser.add_argument('--mjoule', '-j', action='store_true', help='Outputs the value in milli Joule (mJ)')
    ...
    p.measurePowerRealtime(p.mseconds_to_period(args.interval), args.unit)
