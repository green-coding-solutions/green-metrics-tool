...
def check_venv():
    ...
    if os.path.normcase(os.path.realpath(sys.prefix)) != os.path.normcase(venv_path):
        activate_hint = r"venv\Scripts\activate" if platform.system() == 'Windows' else "source venv/bin/activate"
