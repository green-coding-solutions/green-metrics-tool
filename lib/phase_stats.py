    ...
    for idx, phase in enumerate(phases[0]):
        ...
        if machine_power_current_phase and machine_power_baseline and cpu_utilization_machine and cpu_utilization_containers:
            ...
            for detail_name, container_utilization in cpu_utilization_containers.items():
                ...
                csv_buffer.write(generate_csv_line(run_id, 'psu_power_cgroup_slice', detail_name, f"{idx:03}_{phase['name']}", machine_power_current_phase * splitting_ratio, 'MEAN', None, None, None, None, None, 'mW'))
                ...
                csv_buffer.write(generate_csv_line(run_id, 'psu_power_cgroup_container', detail_name, f"{idx:03}_{phase['name']}", surplus_power_runtime * splitting_ratio, 'MEAN', None, None, None, None, None, 'mW'))
