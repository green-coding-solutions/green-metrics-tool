...
CREATE TABLE measurement_values (
    id GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- although not strictly needed PostgreSQL seems to perform way better with it and can vacuum more efficiently
